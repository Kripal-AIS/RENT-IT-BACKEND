...
app.use(cors({
  credentials: true,
  origin: ['http://localhost:3000','https://rent-it-frontend-ftahghbncybhbgdu.australiaeast-01.azurewebsites.net',"https://rent-it-application-dbcfacgceqezh7f4.australiaeast-01.azurewebsites.net"],
